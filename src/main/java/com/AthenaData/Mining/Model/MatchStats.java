...
public class MatchStats {
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(that.xg, xg) == 0 && Float.compare(that.xGa, xGa) == 0 && Float.compare(that.npxG, npxG) == 0 && Float.compare(that.deep, deep) == 0 && Float.compare(that.deep_allowed, deep_allowed) == 0 && Float.compare(that.scored, scored) == 0 && Float.compare(that.missed, missed) == 0 && Float.compare(that.xpts, xpts) == 0 && Float.compare(that.wins, wins) == 0 && Float.compare(that.draws, draws) == 0 && Float.compare(that.loses, loses) == 0 && Float.compare(that.pts, pts) == 0 && Float.compare(that.npxGD, npxGD) == 0 && Float.compare(that.ppda_coef, ppda_coef) == 0 && Float.compare(that.ppda_att, ppda_att) == 0 && Float.compare(that.ppda_def, ppda_def) == 0 && Float.compare(that.oppda_coef, oppda_coef) == 0 && Float.compare(that.oppda_att, oppda_att) == 0 && Float.compare(that.oppda_def, oppda_def) == 0 && Float.compare(that.xG_diff, xG_diff) == 0 && Float.compare(that.xGA_diff, xGA_diff) == 0 && Float.compare(that.xpts_diff, xpts_diff) == 0 && Objects.equals(league, that.league) && Objects.equals(year, that.year) && Objects.equals(h_a, that.h_a) && Objects.equals(result, that.result) && Objects.equals(date, that.date) && Objects.equals(team, that.team);
    }

    @Override
    public int hashCode() {
        return Objects.hash(league, year, h_a, xg, xGa, npxG, deep, deep_allowed, scored, missed, xpts, result, date, wins, draws, loses, pts, npxGD, ppda_coef, ppda_att, ppda_def, oppda_coef, oppda_att, oppda_def, team, xG_diff, xGA_diff, xpts_diff);
    }
